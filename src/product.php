...
<body>
<center>
<div class="add_ctg_heading">PRODUCT</div>
...
<form action="product.php?ctg_id=" method="GET">
...
?>
	...
	<table class="table-striped" style="margin-top:20px; width:60%">
		<thead>
			<tr>
				<th>Category</th>
				<th>Product</th>
		...
		<?php
			$result = mysql_query($sql);
			while($row = mysql_fetch_assoc($result)) {
					echo "<tr> <td>". $row["ctg_name"]."</td> <td>" . $row["product_name"]. "</td><td>".$row["quantity"]."</td><td>".$row["unit_name"]."</td><td><button onclick='removeItem(". $row["product_id"].");'>Remove</button></td> </tr>";
			}
		?>
		</tbody>
	</table>
	<br>
	<br>
	<a href="add_product.php" class="btn btn-primary" style="width:100px">Add New</a>&nbsp;
...
<script type="text/javascript">
	...
	function removeItem(id) {
		var r = confirm("Do you want Remove the Product ?");
		if (r == true) {
			window.location="remove_product.php?product_id=" + id;
		}
	}
